...
class cnn_rnn:
    ...
    def __init__(self, 
        ...
        reshaped_pool5 = self.flatten_tensor(self.pool5)
        # fc6
        #self.fc6 = self.conv_layer('fc6', self.pool5, [], 4096, padding="VALID", fc_layer=True)
        self.fc6 = self.fc_layer('fc6', reshaped_pool5, 4096, trainable=True)
        ...
        #self.fc8 = self.conv_layer('fc8', self.dropout7, [], self.num_class, 
                                   #classifier_layer=True, padding="VALID", fc_layer=True)
    ...
    def fc_layer(self, name, inputs, output_units, trainable):
        ...
        with tf.variable_scope(name) as var_scope:
            ...
            return tf.layers.dense(inputs, output_units, activation=tf.nn.relu, 
                                ...
                                #bias_initializer=tf.constant_initializer(biases, dtype=tf.float32))
